...
>>> no match, partial?`,t,u,e,f),u===a))}let p;if(typeof l=="string"?(p=g===l,this.debug("string match",l,g,p)):(p=l.test(g),this.debug("pattern match",l,g,p)),!p)return!1}if(o===a&&h===c)return!0;if(o===a)return s;if(h===c)return o===a-1&&t[o]==="";throw new Error("wtf?")}braceExpand(){return wt(this.pattern,this.options)}parse(t){C(t);let e=this.options;if(t==="**")return x;if(t==="")return"";let s,n=null;(s=t.match(te))?n=e.dot?se:ee:(s=t.match(Ut))?n=(e.nocase?e.dot?Jt:Ht:e.dot?Ft:Zt)(s[1]):(s=t.match(ie))?n=(e.nocase?e.dot?re:ne:e.dot?oe:he)(s):(s=t.match(Vt))?n=e.dot?Kt:Xt:(s=t.match(Qt))&&(n=Yt);let r=N.fromGlob(t,this.options).toMMPattern();return n&&typeof r=="object"&&Reflect.defineProperty(r,"test",{value:n}),r}makeRe(){if(this.regexp||this.regexp===!1)return this.regexp;let t=this.set;if(!t.length)return this.regexp=!1,this.regexp;let e=this.options,s=e.noglobstar?le:e.dot?ue:fe,n=new Set(e.nocase?["i"]:[]),r=t.map(a=>{let c=a.map(l=>{if(l instanceof RegExp)for(let g of l.flags.split(""))n.add(g);return typeof l=="string"?ye(l):l===x?x:l._src});return c.forEach((l,g)=>{let u=c[g+1],f=c[g-1];l!==x||f===x||(f===void 0?u!==void 0&&u!==x?c[g+1]="(?:\\/|"+s+"\\/)?"+u:c[g]=s:u===void 0?c[g-1]=f+"(?:\\/|"+s+")?":u!==x&&(c[g-1]=f+"(?:\\/|\\/"+s+"\\/)"+u,c[g+1]=x))}),c.filter(l=>l!==x).join("/")}).join("|"),[o,h]=t.length>1?["(?:",")"]:["",""];r="^"+o+r+h+"$",this.negate&&(r="^(?!"+r+").+$");try{this.regexp=new RegExp(r,[...n].join(""))}catch{this.regexp=!1}return this.regexp}slashSplit(t){return this.preserveMultipleSlashes?t.split("/"):this.isWindows&&/^\/\/[^\/]+/.test(t)?["",...t.split(/\/+/)]:t.split(/\/+/)}match(t,e=this.partial){if(this.debug("match",t,this.pattern),this.comment)return!1;if(this.empty)return t==="";if(t==="/"&&e)return!0;let s=this.options;this.isWindows&&(t=t.split("\\").join("/"));let n=this.slashSplit(t);this.debug(this.pattern,"split",n);let r=this.set;this.debug(this.pattern,"set",r);let o=n[n.length-1];if(!o)for(let h=n.length-2;!o&&h>=0;h--)o=n[h];for(let h=0;h<r.length;h++){let a=r[h],c=n;if(s.matchBase&&a.length===1&&(c=[o]),this.matchOne(c,a,e))return s.flipNegate?!0:!this.negate}return s.flipNegate?!1:this.negate}static defaults(t){return m.defaults(t).Minimatch}};m.AST=N;m.Minimatch=$;m.escape=B;m.unescape=M;async function*vt(i,t,e={}){let s=j.default.resolve(i),n=j.default.relative(e.cwd??process.cwd(),i);if((await _.default.stat(s)).isDirectory()){for await(let o of xt(s,"",t,e))yield o;return}m(n,t,e)&&(yield e.absolute===!0?s:n)}async function*xt(i,t,e,s){for await(let n of await _.default.opendir(j.default.join(i,t))){let r=j.default.join(t,n.name),o=j.default.join(i,t,n.name),h=m(r,e,s),a=n.isDirectory();a&&s.nodir===!0&&(h=!1),h&&(yield s.absolute===!0?o:r),a&&(yield*xt(i,r,e,s))}}return Nt(we);})();
return ItGlob}));
