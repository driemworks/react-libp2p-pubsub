(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('uint8arrays'), require('multiformats/basics'), require('@stablelib/sha256'), require('js-sha3'), require('elliptic'), require('@stablelib/ed25519'), require('canonicalize'), require('bech32'), require('@stablelib/x25519'), require('@stablelib/xchacha20poly1305'), require('@stablelib/random'), require('uint8arrays/from-string')) :
  typeof define === 'function' && define.amd ? define(['exports', 'uint8arrays', 'multiformats/basics', '@stablelib/sha256', 'js-sha3', 'elliptic', '@stablelib/ed25519', 'canonicalize', 'bech32', '@stablelib/x25519', '@stablelib/xchacha20poly1305', '@stablelib/random', 'uint8arrays/from-string'], factory) :
  (global = global || self, factory(global.didJwt = {}, global.uint8Arrays, global.basics, global.sha256$1, global.jsSha3, global.elliptic, global.ed25519, global.canonicalize, global.bech32, global.x25519, global.xchacha20poly1305, global.random, global.fromString));
}(this, (function (exports, u8a, basics, sha256$1, sha3, elliptic, ed25519, canonicalizeData, bech32, x25519, xchacha20poly1305, random, fromString) {
