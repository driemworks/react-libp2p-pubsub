...
exports.xsalsa20poly1305 = (0, utils_js_1.wrapCipher)({ blockSize: 64, nonceLength: 24, tagLength: 16 }, (key, nonce) => {
    ...
    return {
        encrypt(plaintext, output) {
            ...
            (0, utils_js_1.clean)(output.subarray(0, tagLength), tag);
        ...
        decrypt(ciphertext, output) {
            ...
            (0, utils_js_1.clean)(authKeyBuf);
            const authKey = (0, exports.xsalsa20)(key, nonce, authKeyBuf, authKeyBuf);
            const tag = (0, _poly1305_js_1.poly1305)(output.subarray(32 + tagLength), authKey); // alloc
            if (!(0, utils_js_1.equalBytes)(output.subarray(32, 48), tag))
                throw new Error('invalid tag');
            // NOTE: first 32 bytes skipped (used for authKey)
            (0, exports.xsalsa20)(key, nonce, output.subarray(16), output.subarray(16));
            // Cleanup
            (0, utils_js_1.clean)(output.subarray(0, 32 + 16), tag);
